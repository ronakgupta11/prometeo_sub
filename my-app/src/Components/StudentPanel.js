...
export default function StudentPanel(props){
    ...
    return(
        ...
        <div className="student-panel-main">
            <StudentProfile name = {data[0].name} image = {data[0].image} balance = {data[0].balance} data = {productsData}/>
            <h3>Activity:</h3>
            {allTransactions}
